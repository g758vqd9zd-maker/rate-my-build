        ...
        <section className="max-w-7xl mx-auto px-6 py-24">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <Link href="https://discord.gg/ratemybuild" target="_blank" rel="noopener noreferrer" className="group inline-flex items-center gap-4 px-12 py-6 text-2xl font-bold bg-gradient-to-r from-purple-600 to-indigo-700 rounded-2xl shadow-2xl shadow-purple-600/60 hover:shadow-purple-600/90 transition-all duration-500 hover:scale-105">
